...
function Support() {
  return (
    <div name="support" className="w-full h-auto mt-24">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 md:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              <FontAwesomeIcon
                icon={faPhone}
                className="w-5 h-auto p-7 bg-indigo-600 text-white rounded-lg mt-[-4rem]"
              />
